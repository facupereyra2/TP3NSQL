...
var utils = require('redis/lib/utils');
var Command = require('redis/lib/command');
var Queue = require('denque');
var errorClasses = require('redis/lib/customErrors');
var EventEmitter = require('events');
var Parser = require('redis-parser');
var RedisErrors = require('redis-errors');
var commands = require('redis-commands');
var debug = require('redis/lib/debug');
var unifyOptions = require('redis/lib/createClient');
...
exports.Multi = require('redis/lib/multi');
...
require('redis/lib/individualCommands');
require('redis/lib/extendedApi');

//enables adding new commands (for modules and new commands)
exports.addCommand = exports.add_command = require('redis/lib/commands');
